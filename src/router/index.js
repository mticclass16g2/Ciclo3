...
const routes = [
  ...
  },
  {
    ...
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Suscripciones.vue')
  },
  {
    path: '/servicios',
    name: 'Servicios',
  ...
  {
    path: '/servicios-categoria/:idCategoria',
    name: 'servicios-categoria',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/ServiciosEnCategoria.vue')
  },  
  {
    path: '/contactenos',
    name: 'Contactenos',
